...
这是“抓猪插件”的独立 MaiBot 插件仓库。当前正式版本为 `1.2.5`，基础六轮开发、经济成长扩展、概率调平、新素材扩充与透明等级加成已经完成。
...
- 数据协议：Schema `6`、Asset Manifest `3`、Ruleset `7`
...
- 每小时生产巡检 SQLite 完整性、全库账本、116 个启用素材文件和过期报价
