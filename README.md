...
这是“抓猪插件”的独立 MaiBot 插件仓库。当前正式版本为 `1.2.0`，基础六轮开发与本轮经济、成长及美食效果扩展已经完成。
...
- 数据协议：Schema `6`、Asset Manifest `3`、Ruleset `4`
...
- 每小时生产巡检 SQLite 完整性、全库账本、102 个启用素材文件和过期报价
