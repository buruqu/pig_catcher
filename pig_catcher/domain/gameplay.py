...
COIN_BOUNTY_REWARD_MULTIPLIER = 3
...
ITEM_DEFINITIONS: tuple[ItemDefinition, ...] = (
    ItemDefinition(
        ...
        "catching",
        840,
        "下一次抓猪：先将基准六档调整为 35% / 27% / 16% / 12% / 7% / 3%，"
    ...
    ItemDefinition(
        ...
        "catching",
        1680,
        "下一次抓猪：先将基准六档调整为 29% / 23% / 15% / 15% / 12% / 6%，"
        "再叠加等级与饲料；4 至 6 星均不会被成长加成压低",
    ),
    ItemDefinition(
        "star-pig-radar",
        ...
        "catching",
        1680,
        "下一次抓猪必为 3 至 6 星，基准概率为 47% / 30% / 18% / 5%；再叠加等级与饲料且不会压低 4 至 6 星",
    ),
    ItemDefinition(
        "giant-corn",
        "巨物玉米",
    ...
    ItemDefinition(
        ...
        "catching",
        320,
        f"下一次抓猪的猪币奖励 ×{COIN_BOUNTY_REWARD_MULTIPLIER}、经验奖励 ×1.5；不改变品质概率",
    ),
    ItemDefinition(
        "chef-spice",
        "主厨香料",
        "cooking",
        480,
        "下一次用 1 至 5 星猪做菜：总预算 18 个百分点，按原分布从低档逐档上移一星；"
        "每份概率只搬一次，不能新增不可达星档",
    ),
    ItemDefinition(
        "super-chef-spice",
