"""Schema 57：允许 Battle v8 规则场按三次战利品结算。"""

from .model import Migration
from .v0056_launch_campaign_and_social_limits import GUARDS as _V0056_GUARDS

GUARDS = _V0056_GUARDS

MIGRATION_0057 = Migration(
    version=57,
    name="battle-rule-v8-loot-total",
    statements=(
        ...
        WHEN NEW.used>NEW.total_uses OR NOT EXISTS(
            ...
            WHERE b.battle_id=NEW.battle_id AND (
                ...
                OR (b.definition_version IN (2,3,4,5,6,7,8) AND NEW.total_uses=3)
            )
        )
