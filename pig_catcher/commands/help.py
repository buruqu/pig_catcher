...
_TOPICS: dict[str, HelpTopic] = {
    ...
    "派遣": HelpTopic(
        (
            ...
            HelpLine("/猪猪派遣 自动 <路线> [4/8/12/24小时]", "dispatch"),
        ...
        (
            "自动模式只选路线即可，按路线特长、体型/重量和熟练度挑最佳空闲队，默认8小时且不带器具。",
            "手动模式仍可自由研究：最多3队，每队1至3只，至少一只1至3星、最多一只高星。",
    ...
    "巡演": HelpTopic(
        (
            HelpLine("/猪猪巡演 自动 <乐队名>", "tour"),
            HelpLine("/猪猪巡演 自动配队 <乐队名>", "tour"),
        ...
        (
            "自动巡演从空闲同团猪中配队、选择已解锁的最高预估路线；收藏猪也可演出且不会被消耗。",
            "自动配队只保存同团阵容、不扣档期；没有乐队档案时会用所选乐队建立第一支乐队。",
