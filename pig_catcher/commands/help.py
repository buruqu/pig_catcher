...
_TOPICS: dict[str, HelpTopic] = {
    ...
    "成就": HelpTopic(
        ...
        (
            ...
            "佩戴会更新该奖励提供的外观部位，其他部位保留；取消佩戴成就会全部卸下。",
    ...
    "对战": HelpTopic(
        (
            HelpLine("/战斗猪 设置 <宿傩猪|五条猪>", "battle"),
        ...
        (
            ...
            "胜利权重从5起累积到整场结束；强化只加招式的胜利数值，不改变抽到招式的概率。",
            HelpLine("自然力竭的败者额外5次战利品抓猪，猪归胜者；基础五星30%、六星20%，只受败者永久加成。", "loot"),
