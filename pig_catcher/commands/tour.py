...
/我的猪猪乐队 改名 新名字；简介 内容；主题色 粉；队徽 星星
/我的猪猪乐队 队长 1；中心 1（阵容位置或猪名）
/我的猪猪乐队 角色 1；成员 1；/乐队练习 猪名
/我的猪猪乐队 风格 猪名 技术；解除保护 猪名
/我的猪猪乐队 客串 绿茶猪（或 取消）；服装 主题名（或 默认）
/我的猪猪乐队 器材；器材 升级；器具；制作 备用线缆 1
/猪猪巡演 场地；曲库 1；主题；合奏
/猪猪巡演 主题 星星落进练习室（同时载入推荐曲目）
/猪猪巡演 路线 街头舞台、街头舞台、街头舞台
/猪猪巡演 编排 1 星屑起跑线、练习室的下午、把星光带回家
/猪猪巡演 高光 1 1、2；合奏 1 自由合奏；器具 1 备用线缆
/猪猪巡演 排练（免费确定性预估，不发进度）
/猪猪巡演 出发；/巡演继续；/巡演一键
/猪猪巡演 结束（放弃剩余站点，不退档期）
/巡演游记 1；/巡演游记 T开头旅程编号；/巡演游记 收藏 1
/巡演联演 @群友；/巡演联演 接受、拒绝、取消（五分钟有效）
